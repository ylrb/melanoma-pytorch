...
data_folder = "isic-2020-resized/train-resized"
label_file = "isic-2020-resized/train-labels.csv"

# Initilise le modèle utilisé pour le fine-tuning et modifie le dernier fully connected pour notre classification binaire
